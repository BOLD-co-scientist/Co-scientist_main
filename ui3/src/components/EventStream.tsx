...
export default function EventStream() {
  const { active, status, events, hasPending, pending, setRightTab, stop, workingHyp, clearWorkingHyp, setMainView, draftNew, startNewSession, sessionBrief, reflectionNudge, dismissReflection, setEvolutionCommand } = useApp();
