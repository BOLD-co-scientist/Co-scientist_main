...
| **R19** | Guided evolution search — proactive, goal-conditioned evolution proposals over the R17 version tree (DGM/HyperAgents archive + selection, MCTS-AHD typed expansion + backprop), human-gated; onboarding goals as the objective; autonomous benchmark arm | Design in discussion (report + 8 open questions recorded 2026-09-06; no code) | [R19-guided-evolution-search.md](docs/plans/R19-guided-evolution-search.md) · [reference note](docs/research/self-improvement-archives.md) | `feat/R19-guided-evolution` | `../coscientist-R19` |
