...
| **R19** | Guided evolution search — proactive, goal-conditioned evolution proposals over the R17 version tree (DGM/HyperAgents archive + selection, MCTS-AHD typed expansion + backprop), human-gated; onboarding goals as the objective; autonomous benchmark arm | 🟢 Backend built + offline-verified (2026-09-07: goal ledger, planner, OpenAI judge at both gates, manual/automatic modes, queue, adoption; 59 tests green). Pending: ui3 panel, platform-scope cutover, live judge run (supplied key rejected by OpenAI) | [R19-guided-evolution-search.md](docs/plans/R19-guided-evolution-search.md) · [reference note](docs/research/self-improvement-archives.md) | `feat/R19-guided-evolution` | `../coscientist-R19` |
